...
and a <tt>.json_create(o)</tt> class method to load the object. If you don't
include this file, you will need to tell <tt>MultiJson</tt> to use the
<tt>json_create</tt> method with:
